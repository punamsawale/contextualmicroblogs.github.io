...
const Util = module.exports = {
   ...
   * Shimmer adds a property if the function is wrapped ('__wrappedStackify')
   *
   * @param {Object}
   * @param {?Function}
   *
  ...
  isMonkeyPatched: function isMonkeyPatched (object, method) {
    ...
    if (!method) {
      return typeof object['__wrappedStackify'] !== 'undefined' && object['__wrappedStackify']
    }

    return typeof object[method] !== 'undefined' && typeof object[method]['__wrappedStackify'] !== 'undefined' && object[method]['__wrappedStackify']
  },
  ...
  isWrappedFunction: function isWrappedFunction (obj) {
    return obj && typeof obj['__isFunctionStackify'] !== 'undefined' && obj['__isFunctionStackify']
  },
  ...
  getOriginalFunction: function getOriginalFunction (obj) {
    return obj && typeof obj['__originalStackify'] !== 'undefined' ? obj['__originalStackify'] : obj
  },
